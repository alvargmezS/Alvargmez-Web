"""
Django settings for alvargmez_web project.
...
SECRET_KEY = 'django-insecure-!vw-)3hgseq+x2$1$a&!4_n6!j68f1ioplaxl9r7&w*j_zty+b'
...
ROOT_URLCONF = 'alvargmez_web.urls'
...
WSGI_APPLICATION = 'alvargmez_web.wsgi.application'
